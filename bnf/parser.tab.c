...
#line 38 "parser.y"
                      { root = (yyvsp[-1].ast); printAST(root, 0); }
#line 1090 "parser.tab.c"
    break;

  case 4: /* expr: expr '+' term  */
#line 42 "parser.y"
                       { (yyval.ast) = createNode("+", (yyvsp[-2].ast), (yyvsp[0].ast), 0); }
...
#line 55 "parser.y"
                       { (yyval.ast) = createNode("num", NULL, NULL, (yyvsp[0].num)); }
